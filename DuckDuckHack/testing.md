...
ddg\_goodie\_test(
	...
	'Belkin f5d6130' =>
        test\_zci(
            # The first argument to test\_zci is the plain text (default)
	...
	'Belkin f5d6130 password default' =>
        test\_zci('Default login for the BELKIN F5D6130: Username: (none) Password: password',
            html => 'Default login for the BELKIN F5D6130:<br><i>Username</i>: (none)<br><i>Password</i>: password'),
