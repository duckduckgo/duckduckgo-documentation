...
In the [`info_detail`](https://duck.co/duckduckhack/spice_templates_reference#basicinfodetail-template) template, the InfoBox floats on the right side of the AnswerBar. It presents detailed information in a table of key-value pairs:
...
- `label` *string* 
- `url` *string* [optional] (Used to turn `label` element into a link)
- `value` *string or array* [optional] (Use array to display [nested properties](#nested-properties))
