# Spice Templates
<h2 id="summary" style="display: none">Spice Template Summary</h2>
<p id="summary-text">There are several built-in Spice templates (both item and detail) which can be used for any Spice.  For more information look these three sections:</p>
